...
def GIF_Genrator(GIF_PATH,data,themenum):
...
def main():
    ...
    t1 = Thread(target=GIF_Genrator, args=(GIF_PATH1,data,0))
    t2 = Thread(target=GIF_Genrator, args=(GIF_PATH2,data,1))
    t3 = Thread(target=GIF_Genrator, args=(GIF_PATH3,data,2))
    t4 = Thread(target=GIF_Genrator, args=(GIF_PATH4,data,3))
    t5 = Thread(target=GIF_Genrator, args=(GIF_PATH5,data,4))
